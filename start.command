...
PRIMARY_SIMULATION="${CODEX_USAGE_MENUBAR_SIMULATE_PRIMARY_AVAILABLE_PERCENT:-${CODEX_USAGE_MENUBAR_SIMULATE_PRIMARY_USED_PERCENT:-${CODEX_LIMITBAR_SIMULATE_PRIMARY_USED_PERCENT:-}}}"
if [[ -n "$PRIMARY_SIMULATION" ]]; then
  SIMULATION_ARGS+=(--simulate-primary-available-percent "$PRIMARY_SIMULATION")
fi

SECONDARY_SIMULATION="${CODEX_USAGE_MENUBAR_SIMULATE_SECONDARY_AVAILABLE_PERCENT:-${CODEX_USAGE_MENUBAR_SIMULATE_SECONDARY_USED_PERCENT:-${CODEX_LIMITBAR_SIMULATE_SECONDARY_USED_PERCENT:-}}}"
if [[ -n "$SECONDARY_SIMULATION" ]]; then
  SIMULATION_ARGS+=(--simulate-secondary-available-percent "$SECONDARY_SIMULATION")
fi
